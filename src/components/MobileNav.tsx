...
export function MobileNav({ showAdmin = false, branch = "SHOP_FLOOR", role = "", fabTier = "", inventory = false, consumables = false }: { showAdmin?: boolean; branch?: string; role?: string; fabTier?: string; inventory?: boolean; consumables?: boolean }) {
    ...
    <div className="fixed inset-0 z-[9999] md:hidden">
      ...
      <div className="absolute inset-y-0 left-0 flex w-72 flex-col bg-white px-4 py-5 shadow-2xl z-[10000]">
        ...
        <div className="flex-1 overflow-y-auto pb-6">
          <Nav showAdmin={showAdmin} branch={branch} role={role} fabTier={fabTier} inventory={inventory} consumables={consumables} />
        </div>
