// The mail-subject vocabulary and defaults, import-free, for the same reason
// as mailBodies.defaults.ts: the settings page's client editor reads these,
// and must not pull the Prisma client in with them.
