...
// riding along into the browser bundle. Re-exported here so every existing
// `from "@/lib/branch"` import keeps working.
import { BRANCHES, BRANCH_LABEL } from "@/lib/branchNames";
import type { BranchName } from "@/lib/branchNames";
export { BRANCHES, BRANCH_LABEL };
