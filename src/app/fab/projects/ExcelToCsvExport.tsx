...
//
// The export half of the CLO Optimizer round-trip on screen: it called
// GET /api/fab/excel-to-clo-csv and downloaded the 2cm and 3cm CLO workbooks.
//
// Replaced mid-2026 by the supervisor slab screen at /fab/supervisor/slabs -- nothing
// leaves the ERP to be nested any more. Its only mount point was /fab/projects/[id],
// where the block that rendered it is commented out too.
//
