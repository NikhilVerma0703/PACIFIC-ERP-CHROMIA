...
export default function FabSinkCuttingPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-900 mb-2">Sink Cutting Queue</h1>
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 text-xs text-gray-500">
              <tr>
                ...
                <th className="text-center px-5 py-3">Cuts</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {pieces.map(p => (
                <tr key={p.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-5 py-3 text-center text-gray-500">{p.requirement?.sinkCuts ?? "—"}</td>
