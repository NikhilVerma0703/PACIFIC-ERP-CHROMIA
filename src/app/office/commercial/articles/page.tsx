    ...
    <>
      <div className="mb-6">
        ...
        <p className="mt-1 max-w-3xl text-sm text-gray-500">
          ...
          generated from these — item code, description, barcode, quantity and shipping date — and the piece label from
          the item code and the size alone. A design packed with no article here prints without a barcode, and the panel
          below says which ones those are.
        </p>
