...
//
// The import half of the CLO Optimizer round-trip: it read the allocation workbook
// that came back from CLO and wrote FabSlab / FabRequirementAllocation rows from it.
//
// Replaced mid-2026 by the supervisor slab screen at /fab/supervisor/slabs, which
// allocates pieces to slabs inside the app via POST /api/fab/supervisor/slab-assignment.
//
...
const GONE =
  "This endpoint has been retired. The CLO allocation Excel upload was replaced by the supervisor slab screen at /fab/supervisor/slabs, which assigns pieces to slabs in the app.";
