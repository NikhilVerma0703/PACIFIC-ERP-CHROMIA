...
export async function GET(req: NextRequest) {
  // THE GATE STAYS. main added roboGate() to every robo route after this
  // branch was cut; taking the branch's version wholesale would have shipped
  // these exports ungated.
