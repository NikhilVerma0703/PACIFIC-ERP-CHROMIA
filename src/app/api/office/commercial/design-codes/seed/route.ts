...
//
// The seed writes NO COLOUR (round two, answer 15): the colour name, the
// L*a*b* and the hex are read off a physical sample, and a guessed one would
// be indistinguishable on screen from a measured one — while being the number
// that decides the queue's cleaning hours (answer 14).
//
...
//
// Gates "write" on the designCodes AREA (_lib.areaRefusal), like the row
// editor beside it: answer 16 left "plan" with the admin alone, and the master
// is the manager's to maintain.
